...
class LandmarkCell: UITableViewCell{
    ...
    func updateViews(from landmark: Landmark){
        nameLabel.text = landmark.name
        pictureImageView.image = landmark.image
    }
}
...
class LandmarkTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as! LandmarkCell
